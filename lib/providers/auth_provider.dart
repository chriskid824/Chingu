...
class AuthProvider with ChangeNotifier {
  ...
  Future<void> _loadUserData(String uid) async {
    try {
      ...
      CrashReportingService().recordError(e, stack, reason: 'Load user data failed');
  ...
  Future<bool> signInWithGoogle() async {
    try {
      ...
      CrashReportingService().recordError(e, stack, reason: 'Sign in with Google failed');
      _errorMessage = e.toString();
      _setLoading(false);
      notifyListeners();
      return false;
  ...
  Future<bool> updateUserData(Map<String, dynamic> data) async {
    try {
      ...
      CrashReportingService().recordError(e, stack, reason: 'Update user data failed');
      _errorMessage = e.toString();
      _setLoading(false);
      notifyListeners();
      return false;
