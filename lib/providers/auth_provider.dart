...
class AuthProvider with ChangeNotifier {
  ...
  UserModel? get user => _userModel; // Alias for legacy code
  ...
  Future<bool> register({
    ...
    try {
      ...
      // 記錄登入歷史
      _recordLoginHistory(firebaseUser.uid);
  ...
  Future<bool> signIn({
    ...
    try {
      ...
      if (_authService.currentUser != null) {
        _recordLoginHistory(_authService.currentUser!.uid);
      }
    ...
    try {
      ...
      try {
        ...
        if (kIsWeb) {
           ...
           deviceInfo = '${webInfo.browserName}';
        } else {
           if (defaultTargetPlatform == TargetPlatform.android) {
              ...
              deviceInfo = '${iosInfo.name} ${iosInfo.model} (${iosInfo.systemName} ${iosInfo.systemVersion})';
           } else {
              deviceInfo = 'Desktop/Other';
           }
        }
      } catch (e) {
      ...
      try {
        ...
        if (response.statusCode == 200) {
          ...
          if (location.trim() == ',') location = 'Unknown';
        }
      } catch (e) {
      ...
      await _firestoreService.addLoginHistory(uid, history);
    } catch (e) {
