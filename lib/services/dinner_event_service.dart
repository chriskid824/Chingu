...
class DinnerEventService {
  ...
  Future<String> createEvent({
    ...
    try {
      ...
      CrashReportingService().recordError(e, s, reason: 'Create Event Service Failed');
  ...
  Future<DinnerEventModel?> getEvent(String eventId) async {
    try {
      ...
      CrashReportingService().recordError(e, s, reason: 'Get Event Failed');
  ...
  Future<List<DinnerEventModel>> getUserEvents(String userId, {String? status}) async {
    try {
      ...
      CrashReportingService().recordError(e, s, reason: 'Get User Events Failed');
  ...
  Future<void> joinEvent(String eventId, String userId) async {
    try {
      ...
      CrashReportingService().recordError(e, s, reason: 'Join Event Service Failed');
  ...
  Future<void> leaveEvent(String eventId, String userId) async {
    try {
      ...
      CrashReportingService().recordError(e, s, reason: 'Leave Event Service Failed');
  ...
  Future<List<DinnerEventModel>> getRecommendedEvents({
    ...
    try {
      ...
      CrashReportingService().recordError(e, s, reason: 'Get Recommended Events Service Failed');
  ...
  Future<String> joinOrCreateEvent({
    ...
    try {
      ...
      CrashReportingService().recordError(e, s, reason: 'Join or Create Event Failed');
