...
class FirestoreService {
  ...
  Future<void> createUser(UserModel userModel) async {
    try {
      ...
      await CrashReportingService().recordError(e, stack, reason: 'createUser failed');
  ...
  Future<UserModel?> getUser(String uid) async {
    try {
      ...
      await CrashReportingService().recordError(e, stack, reason: 'getUser failed');
  ...
  Future<void> updateUser(String uid, Map<String, dynamic> data) async {
    try {
      ...
      await CrashReportingService().recordError(e, stack, reason: 'updateUser failed');
  ...
  Future<void> deleteUser(String uid) async {
    try {
      ...
      await CrashReportingService().recordError(e, stack, reason: 'deleteUser failed');
  ...
  Future<bool> userExists(String uid) async {
    try {
      ...
      await CrashReportingService().recordError(e, stack, reason: 'userExists failed');
  ...
  Future<void> updateLastLogin(String uid) async {
    try {
      ...
      await CrashReportingService().recordError(e, stack, reason: 'updateLastLogin failed');
  ...
  Future<List<UserModel>> queryMatchingUsers({
    ...
    try {
      ...
      await CrashReportingService().recordError(e, stack, reason: 'queryMatchingUsers failed');
  ...
  Future<List<UserModel>> getBatchUsers(List<String> uids) async {
    try {
      ...
      await CrashReportingService().recordError(e, stack, reason: 'getBatchUsers failed');
  ...
  Future<List<UserModel>> searchUsers(String searchTerm,
    ...
    try {
      ...
      await CrashReportingService().recordError(e, stack, reason: 'searchUsers failed');
  ...
  Future<void> updateUserStats(
    ...
    try {
      ...
      await CrashReportingService().recordError(e, stack, reason: 'updateUserStats failed');
  ...
  Future<void> updateUserRating(String uid, double newRating) async {
    try {
      ...
      await CrashReportingService().recordError(e, stack, reason: 'updateUserRating failed');
  ...
  Future<void> submitUserReport({
    ...
    try {
      ...
      await CrashReportingService().recordError(e, stack, reason: 'submitUserReport failed');
