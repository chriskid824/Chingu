...
class FirestoreService {
  ...
  Future<void> createUser(UserModel userModel) async {
    try {
      ...
      CrashReportingService().recordError(e, s, reason: 'Create User Failed');
  ...
  Future<UserModel?> getUser(String uid) async {
    try {
      ...
      CrashReportingService().recordError(e, s, reason: 'Get User Failed');
  ...
  Future<void> updateUser(String uid, Map<String, dynamic> data) async {
    try {
      ...
      CrashReportingService().recordError(e, s, reason: 'Update User Failed');
  ...
  Future<void> deleteUser(String uid) async {
    try {
      ...
      CrashReportingService().recordError(e, s, reason: 'Delete User Failed');
  ...
  Future<bool> userExists(String uid) async {
    try {
      ...
      CrashReportingService().recordError(e, s, reason: 'Check User Exists Failed');
  ...
  Future<void> updateLastLogin(String uid) async {
    try {
      ...
      CrashReportingService().recordError(e, s, reason: 'Update Last Login Failed');
  ...
  Future<List<UserModel>> queryMatchingUsers({
    ...
    try {
      ...
      CrashReportingService().recordError(e, s, reason: 'Query Matching Users Failed');
  ...
  Future<List<UserModel>> getBatchUsers(List<String> uids) async {
    try {
      ...
      CrashReportingService().recordError(e, s, reason: 'Get Batch Users Failed');
  ...
  Future<List<UserModel>> searchUsers(String searchTerm,
    ...
    try {
      ...
      CrashReportingService().recordError(e, s, reason: 'Search Users Failed');
  ...
  Future<void> updateUserStats(
    ...
    try {
      ...
      CrashReportingService().recordError(e, s, reason: 'Update User Stats Failed');
  ...
  Future<void> updateUserRating(String uid, double newRating) async {
    try {
      ...
      CrashReportingService().recordError(e, s, reason: 'Update User Rating Failed');
  ...
  Future<void> submitUserReport({
    ...
    try {
      ...
      CrashReportingService().recordError(e, s, reason: 'Submit User Report Failed');
