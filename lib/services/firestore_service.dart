...
class FirestoreService {
  ...
  Future<void> createUser(UserModel userModel) async {
    try {
      ...
      CrashReportingService().recordHandledException(e, stackTrace, reason: 'FirestoreService.createUser');
  ...
  Future<UserModel?> getUser(String uid) async {
    try {
      ...
      CrashReportingService().recordHandledException(e, stackTrace, reason: 'FirestoreService.getUser');
  ...
  Future<void> updateUser(String uid, Map<String, dynamic> data) async {
    try {
      ...
      CrashReportingService().recordHandledException(e, stackTrace, reason: 'FirestoreService.updateUser');
  ...
  Future<void> deleteUser(String uid) async {
    try {
      ...
      CrashReportingService().recordHandledException(e, stackTrace, reason: 'FirestoreService.deleteUser');
  ...
  Future<bool> userExists(String uid) async {
    try {
      ...
      CrashReportingService().recordHandledException(e, stackTrace, reason: 'FirestoreService.userExists');
  ...
  Future<void> updateLastLogin(String uid) async {
    try {
      ...
      CrashReportingService().recordHandledException(e, stackTrace, reason: 'FirestoreService.updateLastLogin');
  ...
  Future<List<UserModel>> queryMatchingUsers({
    ...
    try {
      ...
      CrashReportingService().recordHandledException(e, stackTrace, reason: 'FirestoreService.queryMatchingUsers');
  ...
  Future<List<UserModel>> getBatchUsers(List<String> uids) async {
    try {
      ...
      CrashReportingService().recordHandledException(e, stackTrace, reason: 'FirestoreService.getBatchUsers');
  ...
  Future<List<UserModel>> searchUsers(String searchTerm,
    ...
    try {
      ...
      CrashReportingService().recordHandledException(e, stackTrace, reason: 'FirestoreService.searchUsers');
  ...
  Future<void> updateUserStats(
    ...
    try {
      ...
      CrashReportingService().recordHandledException(e, stackTrace, reason: 'FirestoreService.updateUserStats');
  ...
  Future<void> updateUserRating(String uid, double newRating) async {
    try {
      ...
      CrashReportingService().recordHandledException(e, stackTrace, reason: 'FirestoreService.updateUserRating');
  ...
  Future<void> submitUserReport({
    ...
    try {
      ...
      CrashReportingService().recordHandledException(e, stackTrace, reason: 'FirestoreService.submitUserReport');
