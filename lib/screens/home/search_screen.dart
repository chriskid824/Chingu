...
class SearchScreen extends StatelessWidget {
      ...
      appBar: AppBar(
        ...
        title: Container(
          ...
          decoration: BoxDecoration(
            ...
            border: Border.all(color: chinguTheme?.surfaceVariant ?? theme.colorScheme.surfaceVariant),
          ),
          child: TextField(
            ...
            child: Row(
              children: [
                Icon(
                  ...
                  color: chinguTheme?.warning ?? theme.colorScheme.error,
                  size: 20,
                ),
          ...
          Padding(
            ...
            child: Wrap(
              ...
              children: [
                ...
                _buildTagChip('日本料理', Icons.ramen_dining_rounded, chinguTheme?.error ?? theme.colorScheme.error),
                _buildTagChip('咖啡廳', Icons.local_cafe_rounded, chinguTheme?.warning ?? theme.colorScheme.error),
  ...
  Widget _buildSearchHistoryItem(IconData icon, String text, Color color, ThemeData theme, ChinguTheme? chinguTheme) {
    return Container(
