  ...
  Widget build(BuildContext context) {
    ...
    if (user == null) {
      return Scaffold(
        ...
        body: const Center(child: Text('找不到用戶資料')),
      );
    }
            ...
            flexibleSpace: FlexibleSpaceBar(
              background: Stack(
                ...
                children: [
                  ...
                  // 配對度標籤 (Static for now, or could be calculated)
                  Positioned(
                    top: 60,
                    right: 20,
                    child: Container(
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  // 操作按鈕 (Keeping bottom buttons as dummy Match/Pass)
                  Row(
                    children: [
                      Expanded(
                      ...
                      Expanded(
                        child: Container(
                          ...
                          child: ElevatedButton(
                            onPressed: () {
                              // TODO: Implement Match/Like Logic
