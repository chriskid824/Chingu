    ...
    return Scaffold(
      ...
      body: ListView(
        children: [
          ...
          _buildListTile(context, Icons.delete_forever, '刪除帳號', () {
            Navigator.of(context).pushNamed(AppRoutes.deleteAccount);
          }, textColor: theme.colorScheme.error.withValues(alpha: 0.8), iconColor: theme.colorScheme.error.withValues(alpha: 0.8)),
          const Divider(),
          // App Settings
