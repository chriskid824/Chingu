            ...
            children: [
              ...
              SwitchListTile(
                ...
                onChanged: (bool value) {
                  _updateSetting(context, authProvider, 'new_match', value);
                },
              ...
              SwitchListTile(
                ...
                onChanged: (bool value) {
                  _updateSetting(context, authProvider, 'new_message', value);
                },
                activeColor: theme.colorScheme.primary,
              ),
              ListTile(
                title: const Text('顯示訊息預覽'),
                subtitle: Text('測試通知樣式', style: TextStyle(color: theme.colorScheme.onSurface.withOpacity(0.6))),
                trailing: Icon(
              ...
              SwitchListTile(
                ...
                value: settings['event_update'] ?? true,
                onChanged: (bool value) {
                  _updateSetting(context, authProvider, 'event_update', value);
                },
                activeColor: theme.colorScheme.primary,
              ),
            ],
