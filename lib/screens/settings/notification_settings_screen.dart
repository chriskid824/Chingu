  ...
  Widget build(BuildContext context) {
    ...
    return Consumer<AuthProvider>(
      builder: (context, authProvider, child) {
        ...
        // Loading state handling could be refined, but for now ensure we have user data
        if (user == null) {
           return Scaffold(
        ...
        void updateSettings(NotificationSettings newSettings) {
          // Note: updateUserData sets isLoading which might trigger rebuilds.
          // For a smoother experience, we might want to handle optimistic updates
          // or avoid full screen loaders in AuthProvider, but adhering to existing patterns:
              ...
              ListView(
                children: [
                  ...
                  SwitchListTile(
                    ...
                    onChanged: (v) => updateSettings(settings.copyWith(enablePushNotifications: v)),
                  ...
                  SwitchListTile(
                    ...
                    onChanged: (v) => updateSettings(settings.copyWith(newMatch: v)),
                    activeColor: theme.colorScheme.primary,
                  ),
                  SwitchListTile(
                    ...
                    onChanged: (v) => updateSettings(settings.copyWith(matchSuccess: v)),
                    activeColor: theme.colorScheme.primary,
                  ),
                  const Divider(),
                  ...
                  SwitchListTile(
                    ...
                    onChanged: (v) => updateSettings(settings.copyWith(newMessage: v)),
                    activeColor: theme.colorScheme.primary,
                  ),
                  ListTile(
                  ...
                  SwitchListTile(
                    ...
                    onChanged: (v) => updateSettings(settings.copyWith(eventReminders: v)),
                    activeColor: theme.colorScheme.primary,
                  ),
                  SwitchListTile(
                    ...
                    onChanged: (v) => updateSettings(settings.copyWith(eventChanges: v)),
                    activeColor: theme.colorScheme.primary,
                  ),
                  const Divider(),
                  ...
                  SwitchListTile(
                    ...
                    onChanged: (v) => updateSettings(settings.copyWith(marketingPromotions: v)),
                    activeColor: theme.colorScheme.primary,
                  ),
                  SwitchListTile(
                    ...
                    onChanged: (v) => updateSettings(settings.copyWith(marketingNewsletter: v)),
                    activeColor: theme.colorScheme.primary,
                  ),
                ],
              ),
