...
class NotificationSettingsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // final chinguTheme = theme.extension<ChinguTheme>(); // Unused variable
          ...
          return ListView(
            children: [
              ...
              SwitchListTile(
                ...
                onChanged: user.enablePushNotifications
                    ? (v) => authProvider.updateUserData({'newMatchNotification': v})
                    : null,
                activeColor: theme.colorScheme.primary,
              ),
              SwitchListTile(
                ...
                onChanged: user.enablePushNotifications
                    ? (v) => authProvider.updateUserData({'matchSuccessNotification': v})
                    : null,
                activeColor: theme.colorScheme.primary,
              ),
              const Divider(),
              ...
              SwitchListTile(
                ...
                onChanged: user.enablePushNotifications
                    ? (v) => authProvider.updateUserData({'newMessageNotification': v})
                    : null,
                activeColor: theme.colorScheme.primary,
              ),
              ListTile(
              ...
              SwitchListTile(
                ...
                onChanged: user.enablePushNotifications
                    ? (v) => authProvider.updateUserData({'eventReminderNotification': v})
                    : null,
                activeColor: theme.colorScheme.primary,
              ),
              SwitchListTile(
                ...
                onChanged: user.enablePushNotifications
                    ? (v) => authProvider.updateUserData({'eventUpdateNotification': v})
                    : null,
                activeColor: theme.colorScheme.primary,
              ),
              const Divider(),
              ...
              SwitchListTile(
                ...
                onChanged: user.enablePushNotifications
                    ? (v) => authProvider.updateUserData({'marketingNotification': v})
                    : null,
                activeColor: theme.colorScheme.primary,
              ),
              SwitchListTile(
                ...
                onChanged: user.enablePushNotifications
                    ? (v) => authProvider.updateUserData({'newsletterNotification': v})
                    : null,
                activeColor: theme.colorScheme.primary,
              ),
            ],
