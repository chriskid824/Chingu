          ...
          return ListView(
            children: [
              ...
              SwitchListTile(
                ...
                onChanged: (val) {
                  authProvider.updateUserData({'enableMatchNotifications': val});
                },
              ...
              SwitchListTile(
                title: const Text('啟用活動通知'),
                subtitle: Text('接收預約提醒和變更通知', style: TextStyle(color: theme.colorScheme.onSurface.withOpacity(0.6))),
