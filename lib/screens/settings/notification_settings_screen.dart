...
class NotificationSettingsScreen extends StatelessWidget {
          ...
          return ListView(
            children: [
              ...
              SwitchListTile(
                ...
                onChanged: (v) {
                  _updatePreferences(context, authProvider, prefs.copyWith(pushEnabled: v));
                },
              ...
              SwitchListTile(
                ...
                onChanged: (v) {
                  _updatePreferences(context, authProvider, prefs.copyWith(newMatch: v));
                },
                activeColor: theme.colorScheme.primary,
              ),
              SwitchListTile(
                ...
                onChanged: (v) {
                  _updatePreferences(context, authProvider, prefs.copyWith(matchSuccess: v));
                },
                activeColor: theme.colorScheme.primary,
              ),
              const Divider(),
              ...
              SwitchListTile(
                ...
                onChanged: (v) {
                  _updatePreferences(context, authProvider, prefs.copyWith(newMessage: v));
                },
                activeColor: theme.colorScheme.primary,
              ),
              ListTile(
              ...
              SwitchListTile(
                ...
                onChanged: (v) {
                  _updatePreferences(context, authProvider, prefs.copyWith(eventReminder: v));
                },
                activeColor: theme.colorScheme.primary,
              ),
              SwitchListTile(
                ...
                onChanged: (v) {
                  _updatePreferences(context, authProvider, prefs.copyWith(eventChange: v));
                },
                activeColor: theme.colorScheme.primary,
              ),
              const Divider(),
              ...
              SwitchListTile(
                ...
                onChanged: (v) {
                  _updatePreferences(context, authProvider, prefs.copyWith(marketingPromo: v));
                },
                activeColor: theme.colorScheme.primary,
              ),
              SwitchListTile(
                ...
                onChanged: (v) {
                  _updatePreferences(context, authProvider, prefs.copyWith(marketingNewsletter: v));
                },
                activeColor: theme.colorScheme.primary,
              ),
            ],
  ...
  void _updatePreferences(BuildContext context, AuthProvider authProvider, NotificationPreferences newPrefs) {
    // 使用 updateUserData 更新 Firestore 中的偏好設定
    // 注意：這會觸發 Firestore 更新，然後 reloadUserData，最後 notifyListeners 更新 UI
