...
class NotificationSettingsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final arePushNotificationsEnabled = settings['pushNotifications'] ?? true;
      ...
      body: authProvider.isLoading
        ...
        children: [
          ...
          SwitchListTile(
            ...
            onChanged: (v) => _updateSetting(context, 'pushNotifications', v),
          ...
          SwitchListTile(
            ...
            value: settings['newMessage'] ?? true,
          ...
          SwitchListTile(
            ...
            value: settings['dinnerReminder'] ?? true,
          ...
          SwitchListTile(
            ...
            value: settings['dinnerChanges'] ?? true,
            onChanged: (v) => _updateSetting(context, 'dinnerChanges', v),
            activeColor: theme.colorScheme.primary,
          ),
          const Divider(),
          ...
          SwitchListTile(
            ...
            value: settings['marketingPromo'] ?? false,
            onChanged: (v) => _updateSetting(context, 'marketingPromo', v),
            activeColor: theme.colorScheme.primary,
          ),
          SwitchListTile(
            ...
            onChanged: (v) => _updateSetting(context, 'marketingNewsletter', v),
            activeColor: theme.colorScheme.primary,
          ),
        ],
      ),
