...
class NotificationSettingsScreen extends StatelessWidget {
  ...
  void _updatePreference(BuildContext context, String key, bool value) {
    final provider = context.read<AuthProvider>();
    provider.updateUserData({key: value});
  }
      ...
      body: ListView(
        children: [
          ...
          SwitchListTile(
            ...
            subtitle: Text('當有新配對或有人喜歡您時通知', style: TextStyle(color: theme.colorScheme.onSurface.withOpacity(0.6))),
            value: user.enableMatchNotifications,
            onChanged: (v) => _updatePreference(context, 'enableMatchNotifications', v),
            activeColor: theme.colorScheme.primary,
          ),
          const Divider(),
          ...
          SwitchListTile(
            ...
            onChanged: (v) => _updatePreference(context, 'enableMessageNotifications', v),
            activeColor: theme.colorScheme.primary,
          ),
          ListTile(
          ...
          SwitchListTile(
            ...
            onChanged: (v) => _updatePreference(context, 'enableEventNotifications', v),
            activeColor: theme.colorScheme.primary,
          ),
          const Divider(),
          ...
          SwitchListTile(
            ...
            onChanged: (v) => _updatePreference(context, 'enableMarketingNotifications', v),
            activeColor: theme.colorScheme.primary,
          ),
        ],
      ),
