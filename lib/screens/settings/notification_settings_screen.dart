      ...
      body: ListView(
        children: [
          ...
          SwitchListTile(
            ...
            onChanged: (v) {
              context.read<AuthProvider>().updateUserData({'pushNotificationsEnabled': v});
            },
          ...
          SwitchListTile(
            ...
            onChanged: (v) {
              context.read<AuthProvider>().updateUserData({'notifyNewMatches': v});
            },
            activeColor: theme.colorScheme.primary,
          ),
          SwitchListTile(
            ...
            onChanged: (v) {
              context.read<AuthProvider>().updateUserData({'notifyMatchSuccess': v});
            },
            activeColor: theme.colorScheme.primary,
          ),
          const Divider(),
          ...
          SwitchListTile(
            ...
            onChanged: (v) {
              context.read<AuthProvider>().updateUserData({'notifyNewMessages': v});
            },
            activeColor: theme.colorScheme.primary,
          ),
          ListTile(
          ...
          SwitchListTile(
            ...
            onChanged: (v) {
              context.read<AuthProvider>().updateUserData({'notifyEventReminders': v});
            },
            activeColor: theme.colorScheme.primary,
          ),
          SwitchListTile(
            ...
            onChanged: (v) {
              context.read<AuthProvider>().updateUserData({'notifyEventChanges': v});
            },
            activeColor: theme.colorScheme.primary,
          ),
          const Divider(),
          ...
          SwitchListTile(
            ...
            value: user.notifyPromotions,
            onChanged: (v) {
              context.read<AuthProvider>().updateUserData({'notifyPromotions': v});
            },
            activeColor: theme.colorScheme.primary,
          ),
          SwitchListTile(
            ...
            onChanged: (v) {
              context.read<AuthProvider>().updateUserData({'notifyNewsletter': v});
            },
            activeColor: theme.colorScheme.primary,
          ),
        ],
