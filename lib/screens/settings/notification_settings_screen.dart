          ...
          return ListView(
            children: [
              ...
              SwitchListTile(
                ...
                onChanged: user.enablePushNotifications ? (v) {
              ...
              SwitchListTile(
                ...
                onChanged: user.enablePushNotifications ? (v) {
                  authProvider.updateUserData({'matchSuccessNotification': v});
                } : null,
                activeColor: theme.colorScheme.primary,
              ),
              const Divider(),
              ...
              SwitchListTile(
                ...
                value: user.appointmentReminderNotification,
                onChanged: user.enablePushNotifications ? (v) {
                  authProvider.updateUserData({'appointmentReminderNotification': v});
                } : null,
                activeColor: theme.colorScheme.primary,
              ),
              SwitchListTile(
                ...
                value: user.appointmentChangeNotification,
                onChanged: user.enablePushNotifications ? (v) {
                  authProvider.updateUserData({'appointmentChangeNotification': v});
                } : null,
                activeColor: theme.colorScheme.primary,
              ),
              const Divider(),
              ...
              SwitchListTile(
                ...
                value: user.promotionsNotification,
                onChanged: user.enablePushNotifications ? (v) {
                  authProvider.updateUserData({'promotionsNotification': v});
                } : null,
                activeColor: theme.colorScheme.primary,
              ),
              SwitchListTile(
                ...
                onChanged: user.enablePushNotifications ? (v) {
                  authProvider.updateUserData({'newsletterNotification': v});
                } : null,
                activeColor: theme.colorScheme.primary,
              ),
            ],
