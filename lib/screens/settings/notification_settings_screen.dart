          ...
          return ListView(
            children: [
              ...
              SwitchListTile(
                ...
                value: user.notifyNewMatch,
                onChanged: (v) {
                  authProvider.updateUserData({'notifyNewMatch': v});
                },
              ...
              SwitchListTile(
                ...
                onChanged: (v) {
                  authProvider.updateUserData({'notifyMatchSuccess': v});
                },
                activeColor: theme.colorScheme.primary,
              ),
              const Divider(),
              ...
              SwitchListTile(
                ...
                value: user.notifyNewMessage,
                onChanged: (v) {
                  authProvider.updateUserData({'notifyNewMessage': v});
                },
                activeColor: theme.colorScheme.primary,
              ),
              ListTile(
              ...
              SwitchListTile(
                ...
                value: user.notifyDinnerReminder,
                onChanged: (v) {
                  authProvider.updateUserData({'notifyDinnerReminder': v});
                },
                activeColor: theme.colorScheme.primary,
              ),
              SwitchListTile(
                ...
                value: user.notifyDinnerChanges,
                onChanged: (v) {
                  authProvider.updateUserData({'notifyDinnerChanges': v});
                },
                activeColor: theme.colorScheme.primary,
              ),
              const Divider(),
              ...
              SwitchListTile(
                ...
                onChanged: (v) {
                  authProvider.updateUserData({'notifyPromotions': v});
                },
                activeColor: theme.colorScheme.primary,
              ),
              SwitchListTile(
                ...
                onChanged: (v) {
                  authProvider.updateUserData({'notifyNewsletter': v});
                },
                activeColor: theme.colorScheme.primary,
              ),
            ],
