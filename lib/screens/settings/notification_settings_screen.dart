    ...
    return Scaffold(
      ...
      body: Consumer<AuthProvider>(
        builder: (context, authProvider, child) {
          ...
          final settings = user?.notificationSettings ?? const NotificationSettings();
          ...
          return ListView(
            children: [
              ...
              SwitchListTile(
                ...
                onChanged: settings.pushEnabled ? (v) => _updateSettings(context, settings.copyWith(eventChange: v)) : null,
                activeColor: theme.colorScheme.primary,
              ),
              const Divider(),
