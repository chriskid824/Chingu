          ...
          return ListView(
            children: [
              ...
              SwitchListTile(
                ...
                subtitle: Text('啟用後，其他用戶將無法看到您是否在線', style: TextStyle(color: theme.colorScheme.onSurface.withOpacity(0.6))),
                value: user.isOnlineHidden,
                onChanged: (bool value) {
                  authProvider.updateUserData({'isOnlineHidden': value});
                },
                activeColor: theme.colorScheme.primary,
              ),
              const Divider(),
              _buildSectionTitle(context, '上線時間'),
              SwitchListTile(
                title: const Text('隱藏最後上線時間'),
                subtitle: Text('啟用後，其他用戶將無法看到您的最後上線時間', style: TextStyle(color: theme.colorScheme.onSurface.withOpacity(0.6))),
