            ...
            children: [
               ...
               SwitchListTile(
                 ...
                 onChanged: (bool value) async {
                   await authProvider.updateUserData({'isOnlineHidden': value});
                 },
               ...
               SwitchListTile(
                 ...
                 subtitle: Text(
                   '啟用後，其他用戶將無法看到您的最後上線時間',
                   style: TextStyle(color: theme.colorScheme.onSurface.withOpacity(0.6)),
                 ),
                 value: user.isLastSeenHidden,
                 onChanged: (bool value) async {
                   await authProvider.updateUserData({'isLastSeenHidden': value});
                 },
                 activeColor: theme.colorScheme.primary,
               ),
