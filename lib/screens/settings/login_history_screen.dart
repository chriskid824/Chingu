...
class _LoginHistoryScreenState extends State<LoginHistoryScreen> {
  ...
  IconData _getDeviceIcon(String device) {
    ...
    if (d.contains('iphone') || d.contains('android') || d.contains('mobile') || d.contains('pixel') || d.contains('samsung')) {
      return Icons.smartphone;
    } else if (d.contains('ipad') || d.contains('tablet')) {
      return Icons.tablet_mac;
    } else if (d.contains('mac') || d.contains('windows') || d.contains('linux') || d.contains('desktop') || d.contains('web')) {
