  ...
  Future<void> _saveProfile() async {
    ...
    try {
      ...
      if (success) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(content: Text('儲存失敗: ${authProvider.errorMessage}')),
        );
      }
    } catch (e) {
      ScaffoldMessenger.of(context).showSnackBar(
        ...
        actions: [
          TextButton(
            ...
            child: _isSaving
                ...
                : Text('儲存', style: TextStyle(color: theme.colorScheme.primary, fontWeight: FontWeight.bold)),
          ),
        ],
      ),
          ...
          child: Column(
            ...
            children: [
                ...
                children: [
                  Expanded(
                    child: TextFormField(
                      ...
                      validator: (v) => v?.isEmpty == true ? '請輸入年齡' : null,
                    ),
                  ),
              ...
              TextFormField(
                ...
                validator: (v) => v?.isEmpty == true ? '請輸入職業' : null,
              ),
              const SizedBox(height: 24),
              ...
              TextFormField(
                ...
                validator: (v) => v?.isEmpty == true ? '請輸入城市' : null,
              ),
              const SizedBox(height: 16),
              TextFormField(
              ...
              // Interests Section
              _buildSectionTitle(context, '❤️ 興趣', Colors.pink),
              const SizedBox(height: 16),
              TextFormField(
                controller: _interestsController,
                decoration: InputDecoration(
                  labelText: '興趣',
                  hintText: '用逗號分隔 (如: 登山, 攝影, 美食)',
                  prefixIcon: const Icon(Icons.favorite_outline, color: Colors.pink),
                  border: OutlineInputBorder(
                    borderRadius: BorderRadius.circular(16),
                    borderSide: BorderSide(color: theme.colorScheme.outline),
                  ),
