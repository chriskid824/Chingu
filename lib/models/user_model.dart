...
class UserModel {
  ...
  factory UserModel.fromMap(Map<String, dynamic> map, String uid) {
    return UserModel(
      ...
      isOnlineStatusVisible: map['isOnlineStatusVisible'] ?? true,
      isLastSeenVisible: map['isLastSeenVisible'] ?? true,
    );
  }
  ...
  Map<String, dynamic> toMap() {
    return {
      ...
      'isLastSeenVisible': isLastSeenVisible,
    };
  }
  ...
  UserModel copyWith({
    ...
    return UserModel(
      ...
      isLastSeenVisible: isLastSeenVisible ?? this.isLastSeenVisible,
    );
  }
