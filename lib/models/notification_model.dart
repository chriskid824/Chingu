...
class NotificationModel {
  ...
  factory NotificationModel.fromMap(Map<String, dynamic> map, String id) {
    return NotificationModel(
      ...
      title: map['title'] ?? '',
      content: map['content'] ?? map['message'] ?? '', // Fallback to 'message' for backward compatibility
  ...
  Map<String, dynamic> toMap() {
    return {
      ...
      'title': title,
      'content': content,
      // 'message': content, // Optional: Keep for backward compatibility if needed, but clean is better
      'imageUrl': imageUrl,
