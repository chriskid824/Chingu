...
enum EventStatus {
  ...
  static EventStatus fromMap(String? val) {
  ...
  String get label {
    switch (this) {
      case EventStatus.pending: return '等待配對';
      case EventStatus.confirmed: return '已確認';
      case EventStatus.completed: return '已完成';
...
class DinnerEventModel {
  ...
  factory DinnerEventModel.fromMap(Map<String, dynamic> map, String id) {
    return DinnerEventModel(
      ...
      status: EventStatus.fromMap(map['status']),
  ...
  /// 檢查用戶是否在等候名單
  bool isWaitlisted(String userId) {
