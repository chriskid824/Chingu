...
import '../../screens/settings/notification_topic_subscription_screen.dart';
...
class AppRoutes {
  ...
  static const String notificationTopicSubscription = '/notification-topic-subscription';
...
class AppRouter {
  ...
  static Route<dynamic> generateRoute(RouteSettings settings) {
    switch (settings.name) {
      ...
      case AppRoutes.notificationTopicSubscription:
        return MaterialPageRoute(builder: (_) => const NotificationTopicSubscriptionScreen());
