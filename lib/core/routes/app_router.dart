...
import '../../screens/events/attendance_confirmation_screen.dart';
...
class AppRouter {
  ...
  static Route<dynamic> generateRoute(RouteSettings settings) {
    switch (settings.name) {
      ...
      case AppRoutes.attendanceConfirmation:
        return MaterialPageRoute(builder: (_) => const AttendanceConfirmationScreen());
