...
class InterestConstants {
  static const List<Map<String, dynamic>> categories = [
    ...
    },
    {
      ...
      'interests': [
        ...
        {'id': 'diy', 'name': '手作', 'icon': Icons.cut_rounded},
  ...
  /// 獲取所有興趣列表
  static List<Map<String, dynamic>> get allInterests {
    return categories
  ...
  /// 根據 ID 獲取興趣名稱
  static String? getInterestNameById(String id) {
    try {
  ...
  /// 根據名稱獲取興趣 ID
  static String? getInterestIdByName(String name) {
    try {
      final interest = allInterests.firstWhere(
